...
do
  ...
  evalepoch=${evalfrom: -3}
  srun time python3 -m openpifpaf.eval \
    --output ${xpdir}/predictions/model_jaad_snip_1_${evalepoch} \
    --dataset jaad \
    --jaad-root-dir /work/vita/datasets/JAAD/ \
    --jaad-subset ${jaadsubset} \
    --jaad-testing-set ${evalsplit} \
...
do
  ...
  evalepoch=${evalfrom: -3}
  srun time python3 -m openpifpaf.eval \
    --output ${xpdir}/predictions/model_jaad_snip_2_${evalepoch} \
    --dataset jaad \
    --jaad-root-dir /work/vita/datasets/JAAD/ \
    --jaad-subset ${jaadsubset} \
    --jaad-testing-set ${evalsplit} \
...
do
  ...
  evalepoch=${evalfrom: -3}
  srun time python3 -m openpifpaf.eval \
    --output ${xpdir}/predictions/model_jaad_snip_3_${evalepoch} \
    --dataset jaad \
    --jaad-root-dir /work/vita/datasets/JAAD/ \
    --jaad-subset ${jaadsubset} \
    --jaad-testing-set ${evalsplit} \
...
do
  ...
  evalepoch=${evalfrom: -3}
  srun time python3 -m openpifpaf.eval \
    --output ${xpdir}/predictions/model_jaad_snip_inf_${evalepoch} \
    --dataset jaad \
    --jaad-root-dir /work/vita/datasets/JAAD/ \
    --jaad-subset ${jaadsubset} \
    --jaad-testing-set ${evalsplit} \
