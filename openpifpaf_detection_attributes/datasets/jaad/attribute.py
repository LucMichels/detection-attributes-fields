...
JAAD_ATTRIBUTE_METAS = {
    JaadType.PEDESTRIAN: [
        ...
        # Hazik
        {'attribute': 'is_crossing_reg',     'group': 'hazik',      'only_on_instance': False, 'is_classification': False, 'is_scalar': True,  'is_spatial': False, 'n_channels': 1, 'default': 0},
        {'attribute': 'is_not_crossing_reg', 'group': 'hazik',      'only_on_instance': False, 'is_classification': False, 'is_scalar': True,  'is_spatial': False, 'n_channels': 1, 'default': 0},
        # Behavior
